    ...
    return (
      <SplashContainer>
        <div className="inner">
          <ProjectTitle />
          <PromoSection>
            <Button href="#try">Create an STO</Button>
...
const FeatureCallout = props => (
  <div
    ...
    <h2>New Releases!</h2>
    <MarkdownBlock>Polymath Core TORO v1.1.0</MarkdownBlock>
  </div>
);
...
const LearnHow = props => (
  <Block background="light">
    {[
      {
        content: 'Check out our tutorial walkthrough for both developers and non-developers',
        image: imgUrl('bull.svg'),
        imageAlign: 'right',
...
const TryOut = props => (
  <Block id="try">
    {[
      {
        content: 'The Polymath dApp is live on the Ethereum Kovan Testnet',
        image: imgUrl('bull.svg'),
        imageAlign: 'left',
        title: 'Try it Out',
      },
